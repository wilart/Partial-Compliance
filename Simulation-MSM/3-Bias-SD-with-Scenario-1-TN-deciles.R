MSM_200_with_covariates <- c(MSM_200_10_27_21_H_3_3_5000_with_covariates_beta_deciles_1_200,
                             MSM_200_10_27_21_H_3_3_5000_with_covariates_beta_deciles_201_400)
...
###########
mean_SD_200_truncnorm <- abs(round(apply(do.call(rbind,lapply((400),function(x) (apply(c(MSM_200_with_covariates)[[x]][[1]][1:5000,],2,mad)))),2,mean),2))
