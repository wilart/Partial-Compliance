...
#Include covariates in potential compliance model
...
computeBetas <- function(niter,dat,H_responders,H_non_responders) {
  ...
  # dat: dataset of the form generated by ComplianceSimulate function in 1-Main-Effects-ENGAGE-Sim.R
  ...
  w_responders=0.5 #Overrepresented by randomizing once and being duplicated
  ...
  for (j in 1:niter) {#Each draw imputes the missing potential compliances after fitting their joint posterior
    ...
    ############# beta's
    #########Add rinvchisq
    #Design matrix for regression of D1_current, D2_current onto baseline covariates
    X_mat_responders <- cbind(X1,X2,X3)[s==1,][,]
    
    
    #Propose point
    #Calculate multiple of empirical variance.
    ...
    ######
    #Design matrix for regression of D1_current, D2_current, and D3_current onto baseline covariates
    ...
    #Design matrix for regression of D1_current, D2_current, and D4_current onto baseline covariates
    ...
    #Regression of compliance onto baseline covariates
